        ...
        return http
            ...
            .authorizeHttpRequests {
                it.apply {
                    ...
                    requestMatchers(HttpMethod.POST, "/theaters/**").hasRole(Role.ADMIN.name)
                    requestMatchers(HttpMethod.POST, "/showtimes/**").hasRole(Role.ADMIN.name)
                    requestMatchers(HttpMethod.DELETE, "/showtimes/**").hasRole(Role.ADMIN.name)
                    requestMatchers(HttpMethod.GET, "/reviews/all").hasRole(Role.ADMIN.name)
